...
class PulseWindow(baseclass, uiclass):
    ...
    def update_plot(self):
        if self.data_buffer:
            ...
            # Keine Notwendigkeit für zusätzlichen Timer-Aufruf hier, da `self.timer` läuft
        else:
            # Nur wenn keine Daten vorhanden sind, berechnen wir die Pause
            if self.time_diff > 0:
                print("calculate pause")
