...
class BLEThread(threading.Thread):
    ...
    async def handle_uuid1_notify(self, sender, data):
        ...
        for i, spo2_value in enumerate(spo2_values, start=2):
            ws.cell(row=i, column=1, value=spo2_value)
    ...
    async def handle_uuid2_notify(self, sender, data):
        ...
        for i, ir_value in enumerate(ir_values, start=2):
            ws.cell(row=i, column=2, value=ir_value)
