...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Variable1:"))
        layout.addWidget(self.variable1_input)
        layout.addWidget(QLabel("Variable2:"))
        layout.addWidget(self.variable2_input)
        layout.addWidget(QLabel("Variable3:"))
        layout.addWidget(self.variable3_input)
        layout.addWidget(QLabel("Variable4:"))
        layout.addWidget(self.variable4_input)
        layout.addWidget(QLabel("Variable5:"))
        layout.addWidget(self.variable5_input)
        layout.addWidget(QLabel("Variable6:"))
